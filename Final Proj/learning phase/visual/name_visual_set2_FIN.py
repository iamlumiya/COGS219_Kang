...
save_dir = "/Users/lumikang/Documents/UCSD/25/Evo_Mod/learning phase/data"
#save_dir = r"C:\Users\l5kang\Documents\Lumi\Evo_mod\learning phase\data"
os.makedirs(save_dir, exist_ok = True)
file_name = os.path.join(save_dir, f"name_v_s2_{timestamp}.csv")
...
for block in range(n):
    ...
    for index, row in block_stimuli.iterrows():
        ...
        distractor_names = random.sample([name for name in stimuli_df['name_s2'] if name != correct_name], 3)
